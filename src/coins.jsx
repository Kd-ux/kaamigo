...
const tasks = [
  ...
  },
  {
    ...
    coins: 80,
    image: 'https://images.unsplash.com/photo-1511379938547-c1f69419868d?auto=format&fit=crop&w=400&q=80', // blockchain visual
  },
  {
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-purple-50 via-white to-orange-50 text-gray-800">
      <div className="max-w-7xl mx-auto py-8 px-4">
        {/* Coin Balance and Bonus */}
        <div className="flex flex-col md:flex-row gap-8 mb-8">
          <div className="flex-1 flex items-center bg-gradient-to-r from-purple-200 via-white to-orange-200 rounded-2xl shadow-xl p-8 border border-purple-100">
            <div className="text-6xl mr-6 text-orange-400"><FaCoins title="Your Coins" /></div>
            <div>
              <div className="text-5xl font-extrabold text-purple-700 mb-2 drop-shadow">1573</div>
              <div className="text-gray-500 text-sm">Last updated: Just now</div>
            </div>
            <button className="ml-auto bg-gradient-to-r from-purple-500 to-orange-400 text-white px-8 py-3 rounded-xl shadow-lg hover:scale-105 transition font-bold text-lg flex items-center gap-2"><FaGift className="text-xl" />Collect Daily Bonus</button>
          </div>
          {/* Recent Transactions */}
          <div className="w-full md:w-80 bg-white rounded-2xl shadow-xl p-6 border border-orange-100">
            <div className="font-bold text-lg text-purple-700 mb-4 flex items-center gap-2"><FaHistory className="text-orange-400" />Recent Transactions</div>
        ...
        <div className="flex flex-col lg:flex-row gap-8">
          ...
          <div className="w-full lg:w-80 bg-white rounded-2xl shadow-xl p-6 h-fit border border-purple-100">
            <div className="font-bold text-lg text-orange-600 mb-4 flex items-center gap-2"><FaTrophy className="text-yellow-500" />Coin Leaderboard</div>
      ...
      <footer className="bg-[#181B23] py-10 text-center text-gray-300 mt-16">
        <div className="mb-4">
          <span className="font-semibold text-purple-300 mr-2">Our Pages:</span>
          <a href="/" className="mx-2 hover:text-orange-400 transition">Home</a>
          <a href="/explore" className="mx-2 hover:text-orange-400 transition">Explore</a>
          <a href="/about" className="mx-2 hover:text-orange-400 transition">About Us</a>
          <a href="/partners" className="mx-2 hover:text-orange-400 transition">Partners</a>
          <a href="/coins" className="mx-2 hover:text-orange-400 transition">Coins</a>
          <a href="/contactus" className="mx-2 hover:text-orange-400 transition">Contact Us</a>
          <a href="/blog" className="mx-2 hover:text-orange-400 transition">Blog</a>
        </div>
